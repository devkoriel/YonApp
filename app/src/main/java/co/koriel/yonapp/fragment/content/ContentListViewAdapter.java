package co.koriel.yonapp.fragment.content;
...
import co.amazonaws.mobile.content.ContentRemovedListener;
...
public class ContentListViewAdapter extends ArrayAdapter<ContentListItem>
    ...
    public ContentListViewAdapter(final Context context,
        ...
        folderText = getContext().getString(co.koriel.yonapp.R.string.content_folder_text);
    ...
    private View generateContentItem(final LayoutInflater inflater, final ContentListItem listItem,
        ...
        if (convertView != null) {
            ...
            itemView = inflater.inflate(
                co.koriel.yonapp.R.layout.demo_content_list_item, null);
            holder = new ViewHolder();
            holder.fileNameText = fileNameText = (TextView) itemView.findViewById(
                co.koriel.yonapp.R.id.content_delivery_file_name);
            holder.fileSizeText = fileSizeText = (TextView) itemView.findViewById(
                co.koriel.yonapp.R.id.content_delivery_file_size_text);
            holder.downloadImage = downloadImage = (ImageView) itemView
                .findViewById(co.koriel.yonapp.R.id.content_delivery_file_download_image);
            holder.downloadPercentText = downloadPercentText = (TextView) itemView.findViewById(
                co.koriel.yonapp.R.id.content_delivery_download_percentage);
            holder.favoriteImage = favoriteImage = (ImageView) itemView.findViewById(
                co.koriel.yonapp.R.id.content_delivery_favorite_image);
        ...
        switch (contentState) {
            ...
            case CACHED_NEW_VERSION_TRANSFER_WAITING:
                downloadImage.setImageResource(co.koriel.yonapp.R.mipmap.icon_delay);
                break;
            case TRANSFERRING:
            ...
            case CACHED:
                ...
                downloadImage.setImageResource(co.koriel.yonapp.R.mipmap.icon_check);
                break;
            case CACHED_WITH_NEWER_VERSION_AVAILABLE:
                // Show the check mark with the download icon on top.
                downloadImage.setImageResource(co.koriel.yonapp.R.mipmap.icon_check_dated);
                break;
        }
        ...
        if (contentManager.isContentPinned(contentName)) {
            favoriteImage.setImageResource(co.koriel.yonapp.R.mipmap.icon_star);
    ...
    public void onError(final String filePath, final Exception ex) {
        ...
        errorDialogBuilder.setTitle(context.getString(co.koriel.yonapp.R.string.content_transfer_failure_text));
        errorDialogBuilder.setMessage(ex.getMessage());
        errorDialogBuilder.setNegativeButton(
            context.getString(co.koriel.yonapp.R.string.content_dialog_ok), null);
    ...
    public void onRemoveError(File file) {
        ...
        errorDialogBuilder.setTitle(getContext().getString(co.koriel.yonapp.R.string.content_removal_error_text));
        errorDialogBuilder.setMessage(String.format("Can't remove file '%s'.", file.getName()));
        errorDialogBuilder.setNegativeButton(
            getContext().getString(co.koriel.yonapp.R.string.content_dialog_ok), null);
        errorDialogBuilder.show();
    }
}
